...
> 현재 데이터가 공개되지 않아 정량적인 수치를 비교할 방법론이 아직 없습니다. 데이터가 정식 공개되면 다시 학습 후 업데이트할 예정입니다.

## 1.2. 정성적인 평가

정성평가에서는 기존 KoBART와 가장 좋은 성능을 보인 DistilKoBART-6-3을 사용하였습니다.
...
|   1   | DistilKoBART (6-3) | 호남지방통계청에 따르면 지난해 완도군 전체 인구 대비 청년은 30.6%로 전국 44.8%, 전남 37.5%보다 낮아 청년들의 생활 만족도 향상과 지역발전에 기여할 것으로 보고 있다.                                                                                                                                                               |

> DistilKoBART의 경우 원문의 내용이 일부 생략되어 사실과 다른 문장을 생성하는 것을 확인할 수 있습니다.
...
|   2   | DistilKoBART (6-3) | 달콤커피는 가수이자 화가로 전천후 활동 중인 '진한 음색' 솔비를 '이 달의 아티스트'로 선정하고, 오는 15일과 22일 오후 8시부터 각각 달콤커피 논현점과 산본피트인점에서 베란다라이브 공연을 실시한다고 5일 밝혔다. |
...
|   3   | DistilKoBART (6-3) | 익산시는 4일 근로복지공단 익산지사,지역자활센터, 소상공인시장진흥공단 익산센터, 지역 소재 금융회사 등 유관기관과 간담회를 갖고‘서민금융 지역협의체’를 구축했다고 밝혔으며 협약에 따라 각 기관은 앞으로 시민 개개인의 상황과 목적에 맞는 다양한 맞춤형 금융서비스를 안내하고 제공받을 수 있도록 지원한다. |
...
| Ours 1 (DistilKoBART-6-3)                                                                                                                                                                    |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| SK텔레콤(대표 박정호)이 자체 개발한 AI 반도체 ‘SAPEON X220’를 25일 공개하며 인공지능 서비스 구현에 필요한 대규모 연산을 초고속·저전력으로 실행하는 비메모리 반도체 ‘SAPEON X220’를 선보였다. |
...
| Ours 2 (DistilKoBART-6-3)                                                                                                                                                                                                                                |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 코로나19(신종 코로나 바이러스 감염증) 3차 대유행의 확산세가 거세지고 있는 가운데 16일 신규 확진자 수는 또다시 1000명 선을 넘어 지난 13일 1030명 이후 사흘만에 1000명대로 올라섰으며 지난 1월20일 국내 첫 코로나19 확진자 발생 이후 최다 기록도 경신됐다. |
...
|                                                                                                               원 문장                                                                                                               |                                                                                                                      음역 문장                                                                                                                      |
| :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|                             범정부 코로나**19** 백신도입 **TF**는 이날 이렇게 밝히고, 이스라엘과 백신 교환으로 공급되는 화이자 백신은 오는 **7일** 오전 **7시 15분**에 인천공항에 들어온다고 설명했다.                              |                               범정부 코로나**일구** 백신도입 **티에프**는 이날 이렇게 밝히고, 이스라엘과 백신 교환으로 공급되는 화이자 백신은 오는 **칠일** 오전 **일곱시 십오분**에 인천공항에 들어온다고 설명했다.                                |
| **AI**전문기업 마인즈랩 이종미 전무는 "**25종** 이상의 지능형 **CCTV** 서비스가 개발된 일본과 달리 우리나라는 아직 초기 수준"이라며 "정부 주도의 데이터 확보와 실증 연구 사업으로 우리 역시 개발속도를 높일 수 있게 됐다"고 말했다. | **에이아이**전문기업 마인즈랩 이종미 전무는 "**이십오종** 이상의 지능형 **시시티브이** 서비스가 개발된 일본과 달리 우리나라는 아직 초기 수준"이라며 "정부 주도의 데이터 확보와 실증 연구 사업으로 우리 역시 개발속도를 높일 수 있게 됐다"고 말했다. |

## 2.2. Bad Examples

|                                                                                 원 문장                                                                                  |                                                                                 음역 문장                                                                                 |
| :----------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|                                               2단계는 '9인 이상 사적모임 금지' 기준에 따라 최대 **8명**까지 모일 수 있다.                                                |                                              이단계는 '구인 이상 사적모임 금지' 기준에 따라 최대 **팔명**까지 모일 수 있다.                                               |
| 재건축 아파트의 경우 작년 말부터 최근까지 가격 상승 속도가 일반 아파트보다 **2배** 빨랐던 것을 감안하면 재건축 아파트 매도자가 치른 기회비용은 이보다 더 클 수밖에 없다. | 재건축 아파트의 경우 작년 말부터 최근까지 가격 상승 속도가 일반 아파트보다 **이배** 빨랐던 것을 감안하면 재건축 아파트 매도자가 치른 기회비용은 이보다 더 클 수밖에 없다. |
...
|                                                                              원본                                                                              |                             합성                              |
| :------------------------------------------------------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------: |
| <audio preload="auto" controls><source src='https://raw.githubusercontent.com/youngerous/kobart-voice-summarization/main/assets/장기하_소개_원본.mp3'></audio> | <audio controls><source src='assets/장기하_소개_합성.wav'></audio> |
